  ...
  const formatSunriseTime = () => {
    try {
      if (weatherData.sys && 
        ...
        console.log("Sunrise timestamp:", weatherData.sys.sunrise, "Date:", date);
      ...
      return '6:15 AM'; // Default fallback
    } catch (e) {
      console.error("Error formatting sunrise time:", e);
      return '6:15 AM'; // Error fallback
    }
  };

  // Format sunset time with proper error handling
  const formatSunsetTime = () => {
    try {
      if (weatherData.sys && 
        ...
        console.log("Sunset timestamp:", weatherData.sys.sunset, "Date:", date);
        return date.toLocaleTimeString('en-US', { 
          hour: 'numeric', 
          minute: '2-digit',
          hour12: true 
      ...
      return '7:45 PM'; // Default fallback
    } catch (e) {
      console.error("Error formatting sunset time:", e);
      return '7:45 PM'; // Error fallback
    }
  };
